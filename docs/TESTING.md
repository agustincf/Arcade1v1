...
| `packages/contracts`      | `Escrow1v1.t.sol` (14 tests), `EscrowAleph.t.sol` (59 tests)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Foundry (`forge test`) |
...
`EscrowAleph.t.sol` (59 tests). The Aleph suite runs against `BlacklistUSDC`
(a mock with Circle's blacklist and pause, identical to `MockUSDC` until a test
flips them) and also uses `GasHungryUSDC` (an expensive-to-pay token that opens
the "just enough gas" window the escrow's gas guard closes) and
`ReentrantUSDC`:
