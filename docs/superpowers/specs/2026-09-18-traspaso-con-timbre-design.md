...
| La nueva se cae después de cargar y antes de estar sana         | Durante un deploy, Render NO reinicia una instancia nueva que se cayó: el deploy queda fallido. La vieja (`released`) ve la posta en manos de una instancia muerta; espera a que venza (≤ 3 min) y, si nadie la tomó en el medio, la retoma. Si en el medio pasó otra época (huérfana, de la instancia que se cayó), espera otros 90 s libres y sale con 1 (3.5.1) para que Render la reinicie y recargue. En total, unos 5 min de 503. |
