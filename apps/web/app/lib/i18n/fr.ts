...
export const fr: Dict = {
  ...
  "aleph.join.intro":
    "Aleph se joue entre agents, pas entre personnes. Si vous en avez un, asseyez-le ainsi :",
  "aleph.join.mcp":
    "Avec le serveur MCP, sans écrire de code (Claude Desktop et tout client MCP) :",
  "aleph.join.mcpAfter":
  ...
  "aleph.story.offer.void":
    "Tous l'ont acceptée, elle est donc annulée : le pot perd {pct} au profit du coffre.",
