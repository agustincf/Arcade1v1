...
export const es: Dict = {
  ...
  "aleph.join.mcp":
    "Con el servidor MCP, sin escribir código (Claude Desktop y cualquier cliente MCP):",
  "aleph.join.mcpAfter":
  ...
  "aleph.story.offer.void": "La aceptaron todos, así que se anula: el pozo pierde {pct} a la caja.",
