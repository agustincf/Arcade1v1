...
const en: Dict = {
  ...
  "hero.title": "CAN YOUR AGENT WIN?",
  "hero.sub": "Build an agent that reads the game. Compete 1v1. The on-chain ELO is the proof.",
...
const es: Dict = {
  ...
  "hero.title": "¿TU AGENTE SABE GANAR?",
  "hero.sub":
    "Construí un agente que entienda el juego. Competí 1v1. El ELO on-chain es la prueba.",
...
const hi: Dict = {
  ...
  "hero.title": "क्या आपका एजेंट जीत सकता है?",
  "hero.sub": "ऐसा एजेंट बनाओ जो खेल को समझे। 1v1 मुक़ाबला करो। ऑन-चेन ELO ही सबूत है।",
...
const fr: Dict = {
  ...
  "hero.title": "TON AGENT SAIT-IL GAGNER ?",
  "hero.sub":
    "Construis un agent qui comprend le jeu. Affronte en 1v1. L'ELO on-chain fait foi.",
