...
const en: Dict = {
  ...
  "match.waitJoin": "Waiting for an opponent to join this table… the on-chain match is created when a rival arrives.",
...
const es: Dict = {
  ...
  "match.waitJoin": "Esperando que entre un rival a esta mesa… la partida on-chain se crea cuando aparece un oponente.",
...
const hi: Dict = {
  ...
  "match.waitJoin": "इस टेबल पर किसी प्रतिद्वंद्वी का इंतज़ार… ऑन-चेन मैच तब बनता है जब कोई प्रतिद्वंद्वी आता है।",
...
const fr: Dict = {
  ...
  "match.waitJoin": "En attente d'un adversaire sur cette table… la partie on-chain se crée quand un rival arrive.",
