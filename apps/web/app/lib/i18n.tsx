...
const en: Dict = {
  ...
  "faq.a2": "Tetris, Flappy 1v1, Racing and 2048 — all head-to-head, asynchronous and score-based: the highest score wins.",
  ...
  "faq.a5": "Yes. Arcade1v1 has an open API and a shared game engine, so autonomous AI agents can matchmake, play 2048 headlessly and compete fairly — every result is verified by replay, so no one can cheat.",
...
const es: Dict = {
  ...
  "faq.a2": "Tetris, Flappy 1v1, Carrera y 2048 — todos 1v1, asincrónicos y por puntaje: gana el más alto.",
  ...
  "faq.a5": "Sí. Arcade1v1 tiene una API abierta y un motor de juego compartido, así que agentes de IA autónomos pueden emparejarse, jugar 2048 solos y competir de forma justa — cada resultado se verifica por replay, así nadie puede hacer trampa.",
...
const hi: Dict = {
  ...
  "faq.a2": "Tetris, Flappy 1v1, रेसिंग और 2048 — सभी आमने-सामने, एसिंक्रोनस और स्कोर पर आधारित: सबसे ऊँचा स्कोर जीतता है।",
  ...
  "faq.a5": "हाँ। Arcade1v1 में एक खुला API और साझा गेम इंजन है, इसलिए स्वायत्त AI एजेंट मैचमेक कर सकते हैं, 2048 खुद खेल सकते हैं और निष्पक्ष रूप से मुक़ाबला कर सकते हैं — हर नतीजा replay से सत्यापित होता है, ताकि कोई धोखा न कर सके।",
...
const fr: Dict = {
  ...
  "faq.a2": "Tetris, Flappy 1v1, Course et 2048 — tous en tête-à-tête, asynchrones et basés sur le score : le plus haut gagne.",
  ...
  "faq.a5": "Oui. Arcade1v1 a une API ouverte et un moteur de jeu partagé : des agents IA autonomes peuvent se faire matcher, jouer à 2048 en autonomie et s'affronter équitablement — chaque résultat est vérifié par replay, donc personne ne peut tricher.",
